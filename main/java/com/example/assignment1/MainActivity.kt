...
class MainActivity : AppCompatActivity() {
    ...
    //function to provide a suggestion based on the input of time of day
    private fun getSocialSparkSuggestion(timeOfDay: String): String {
        return when (timeOfDay) {
            ...
            "after dinner" -> "night leave a thought comment on friend's post."
            else -> "" // Return empty if valid input
